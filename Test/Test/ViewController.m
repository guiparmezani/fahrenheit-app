...
- (void)viewDidLoad
{
    ...
    [pageScrollView setScrollViewContents:@[[UIImage imageNamed:@"main.png"], [UIImage imageNamed:@"page-seo.png"], [UIImage imageNamed:@"page-responsiveness.png"], [UIImage imageNamed:@"page-online-marketing.png"]]];
